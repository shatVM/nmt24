var usersFromGroup = {
  ...
  '11-Б': [
    'Багінський  Ілля', 'Головня  Богдан', 'Горностай  Анастасія ', 'Губін  Владислав ', 'Задоєнко  Роман','Кавешніков Артем', 'Карталіш  Оскар', 'Кирій Глєб', 'Коломієць  Артем ', 'Копаниця Дмитро', 'Кошарська Анастасія ', 'Кошицький Олексій','Ляховець Ангеліна', 'Мельниченко Іван', 'Михалюк Софія', 'Місіонжнік Нікіта', 'Новак Данило', 'Павелеску Іван', 'Павлюк Дарина', 'Романчук Максим', 'Рослякова Ніна', 'Слівко Микола', 'Соколов Владислав', 'Соколов  Владислав ', 'Ущапівський Іван', 'Ущапівський Іван', 'Фотін Андрій', 'Хоменко Владислав', 'Хомик Анна', 'Шахрай Артем'
  ]
  ,
  '11-В': [
